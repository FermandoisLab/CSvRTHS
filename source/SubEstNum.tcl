...
expElement twoNodeLink 2 2 4 -dir 2 -server 8091 127.0.0.1 -tcp -initStif 5.6;  # use with SimAppSiteServer
...
expElement twoNodeLink 3 3 4 -dir 1 -server 8092 127.0.0.1 -tcp -initStif 2.0;  # use with SimAppSiteServer
