...
int initData(int ndof, double dtcon, double dtsim, double dtint)
{
    ...
    sig3  = calloc(nDOF, sizeof(double));
    sig4  = calloc(nDOF, sizeof(double));
    sig5  = calloc(nDOF, sizeof(double));
    sig6  = calloc(nDOF, sizeof(double));
    sigXi = calloc(nDOF, sizeof(double));
    ...
    sigDot1 = calloc(nDOF, sizeof(double));
    sigDot2 = calloc(nDOF, sizeof(double));
    ...
    sigDotDot1 = calloc(nDOF, sizeof(double));
